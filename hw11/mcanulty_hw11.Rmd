...
is not that low at all compared to the other values.  The depth at 5 is high, but it also corresponds to the 
width of the stream being 12.  This slighlty deeper and wider part of the stream is certainly possible.  I would ultimately say that the 
...
Nitrite concentration has two bands of none and .001 with several with higher concentrations.  Again, depending on what is being analyzed, possibly more accurate testing could be perfromed.
...
I chose the binwidths of .01, .01, and .1 respectively due to data being lost are spaced out even more than it is at other values.
...
In my opinion, as meaningless at this point in my career as it might be, there just isn't enough data points per variable to really see any meaningful trends in these variables. The more data points, the more trends can be seen.
...
aegla_wrangled %>%
  ggpairs()
```
The strongest correlation that I can see is Cond vs. TDS with a coorelation factor of 0.997. Which this makes sense, the more solids to conduct, the more conductivity.   Depth vs. Width also has a 0.733.  pH vs. Cond and TDS has almost the same coorelation of 0.536 and 0.535 respectively. Nitrogen, Magnesium, and Calcium Concentrations vs. Cond is very stong, with Calcium having a negative relationship.  There are some more coorelations that can be made, but for the most part most of the others shows no relation.  This ggpairs is awesome, very fun to play around with. 
